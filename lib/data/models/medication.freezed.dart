...
mixin _$Medication {
 ...
 String get id; String get name; double get dosage; DosageUnit get dosageUnit; PillShape get shape; PillColor get color; String? get photoPath; String? get scheduleId; int get inventoryTotal; int get inventoryRemaining; int get lowStockThreshold; bool get isCritical; bool get isIppoka; DateTime get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, String name, double dosage, DosageUnit dosageUnit, PillShape shape, PillColor color, String? photoPath, String? scheduleId, int inventoryTotal, int inventoryRemaining, int lowStockThreshold, bool isCritical, bool isIppoka, DateTime createdAt, DateTime? updatedAt
});
...
as bool,isIppoka: null == isIppoka ? _self.isIppoka : isIppoka // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double dosage,  DosageUnit dosageUnit,  PillShape shape,  PillColor color,  String? photoPath,  String? scheduleId,  int inventoryTotal,  int inventoryRemaining,  int lowStockThreshold,  bool isCritical,  bool isIppoka,  DateTime createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Medication() when $default != null:
return $default(_that.id,_that.name,_that.dosage,_that.dosageUnit,_that.shape,_that.color,_that.photoPath,_that.scheduleId,_that.inventoryTotal,_that.inventoryRemaining,_that.lowStockThreshold,_that.isCritical,_that.isIppoka,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Medication implements Medication {
  const _Medication({required this.id, required this.name, required this.dosage, required this.dosageUnit, this.shape = PillShape.round, this.color = PillColor.white, this.photoPath, this.scheduleId, this.inventoryTotal = 30, this.inventoryRemaining = 30, this.lowStockThreshold = 5, this.isCritical = false, this.isIppoka = false, required this.createdAt, this.updatedAt});
...
@override@JsonKey() final  bool isIppoka;

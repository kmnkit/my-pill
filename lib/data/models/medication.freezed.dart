...
mixin _$Medication {
 ...
 String get id; String get name; double get dosage; DosageUnit get dosageUnit; PillShape get shape; PillColor get color; String? get photoPath; String? get scheduleId; int get inventoryTotal; int get inventoryRemaining; int get lowStockThreshold; bool get isCritical; DateTime get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,dosage,dosageUnit,shape,color,photoPath,scheduleId,inventoryTotal,inventoryRemaining,lowStockThreshold,isCritical,createdAt,updatedAt);

@override
String toString() {
  return 'Medication(id: $id, name: $name, dosage: $dosage, dosageUnit: $dosageUnit, shape: $shape, color: $color, photoPath: $photoPath, scheduleId: $scheduleId, inventoryTotal: $inventoryTotal, inventoryRemaining: $inventoryRemaining, lowStockThreshold: $lowStockThreshold, isCritical: $isCritical, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, double dosage, DosageUnit dosageUnit, PillShape shape, PillColor color, String? photoPath, String? scheduleId, int inventoryTotal, int inventoryRemaining, int lowStockThreshold, bool isCritical, DateTime createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double dosage,  DosageUnit dosageUnit,  PillShape shape,  PillColor color,  String? photoPath,  String? scheduleId,  int inventoryTotal,  int inventoryRemaining,  int lowStockThreshold,  bool isCritical,  DateTime createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Medication() when $default != null:
return $default(_that.id,_that.name,_that.dosage,_that.dosageUnit,_that.shape,_that.color,_that.photoPath,_that.scheduleId,_that.inventoryTotal,_that.inventoryRemaining,_that.lowStockThreshold,_that.isCritical,_that.createdAt,_that.updatedAt);case _:
  return orElse();

...
mixin _$UserProfile {
 ...
 String get id; String? get name; String? get email; String get language; bool get highContrast; String get textSize; bool get notificationsEnabled; bool get criticalAlerts; int get snoozeDuration; bool get travelModeEnabled; String? get homeTimezone; bool get removeAds; bool get usesPrivateEmail; bool get onboardingComplete; String get userRole;// deprecated — use isCaregiver
 bool get isCaregiver; bool get shareAdherenceData; bool get shareMedicationList; bool get allowCaregiverNotifications; bool get missedDoseAlerts; bool get lowStockAlerts; bool get defaultIppoka;
...
@useResult
$Res call({
 String id, String? name, String? email, String language, bool highContrast, String textSize, bool notificationsEnabled, bool criticalAlerts, int snoozeDuration, bool travelModeEnabled, String? homeTimezone, bool removeAds, bool usesPrivateEmail, bool onboardingComplete, String userRole, bool isCaregiver, bool shareAdherenceData, bool shareMedicationList, bool allowCaregiverNotifications, bool missedDoseAlerts, bool lowStockAlerts, bool defaultIppoka
});
...
as String,isCaregiver: null == isCaregiver ? _self.isCaregiver : isCaregiver // ignore: cast_nullable_to_non_nullable
as bool,shareAdherenceData: null == shareAdherenceData ? _self.shareAdherenceData : shareAdherenceData // ignore: cast_nullable_to_non_nullable
as bool,shareMedicationList: null == shareMedicationList ? _self.shareMedicationList : shareMedicationList // ignore: cast_nullable_to_non_nullable
...
class _UserProfile implements UserProfile {
  const _UserProfile({required this.id, this.name, this.email, this.language = 'en', this.highContrast = false, this.textSize = 'normal', this.notificationsEnabled = true, this.criticalAlerts = false, this.snoozeDuration = 15, this.travelModeEnabled = false, this.homeTimezone, this.removeAds = false, this.usesPrivateEmail = false, this.onboardingComplete = false, this.userRole = 'patient', this.isCaregiver = false, this.shareAdherenceData = true, this.shareMedicationList = true, this.allowCaregiverNotifications = true, this.missedDoseAlerts = true, this.lowStockAlerts = true, this.defaultIppoka = false});
...
// deprecated — use isCaregiver
@override@JsonKey() final  bool isCaregiver;
@override@JsonKey() final  bool shareAdherenceData;
@override@JsonKey() final  bool shareMedicationList;

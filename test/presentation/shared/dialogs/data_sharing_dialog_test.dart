...
void main() {
  group('DataSharingDialog', () {
    ...
    testWidgets('tapping shareAdherenceData toggle calls updateProfile with toggled value',
        (tester) async {
    ...
    testWidgets('tapping shareMedicationList toggle calls updateProfile with toggled value',
        (tester) async {
      final notifier = _TrackingUserSettings(_allOnProfile);
    ...
    testWidgets('tapping allowCaregiverNotifications toggle when OFF turns it ON',
        (tester) async {
      final notifier = _TrackingUserSettings(_allOffProfile);
    ...
    testWidgets('show() returns a Future that completes when dialog is dismissed',
        (tester) async {

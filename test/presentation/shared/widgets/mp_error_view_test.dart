...
void main() {
  group('MpErrorView', () {
    testWidgets('renders error icon', (tester) async {
      await tester.pumpWidget(
        createTestableWidget(
          const MpErrorView(error: 'something went wrong'),
        ),
      );
    ...
    testWidgets('renders generic error message for generic error', (tester) async {
      await tester.pumpWidget(
        createTestableWidget(
          const MpErrorView(error: 'some random error'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('renders network error message for SocketException', (tester) async {
      await tester.pumpWidget(
        createTestableWidget(
    ...
    testWidgets('retry button absent when onRetry not provided', (tester) async {
      await tester.pumpWidget(
        createTestableWidget(
          const MpErrorView(error: 'some error'),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('renders generic error message in Japanese locale', (tester) async {
      await tester.pumpWidget(
